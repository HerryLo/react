...
/*微信联合登陆*/
import RelatedList from './related.childRouters.js'
...
const champion = {
  ...
  getComponent(nextState, cb) {
    require.ensure([], (require) => {
      cb(null, require('../Components/LotteryBetting/champion/index.js').default)
    })
  }
}
/*玩法说明*/
