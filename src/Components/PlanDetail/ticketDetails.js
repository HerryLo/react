...
class ChildComponent extends Component {
  ...
  render() {
    ...
    const time = data && data.ticketDate && data.ticketDate.split(' ')||[];
    ...
    return (
      <tr>
        ...
        <td className="td2">
          ...
          <p className="grayColor">{mul}倍{gg&&"；"+gg}</p>
          {gglen > 1 && <p className="lookP"><Link
            to={`/planDetail/cpxq?gid=${gid}&hid=${hid}&index=${index}&isflag=${isflag}`}>查看详情</Link></p>}
        </td>
