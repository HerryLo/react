...
export class ThreetongHaoDanXuan extends Component {
    ...
    return (
      <div className="xk3Betting"  style={{height: ConHeight,overflow: 'auto'}}>
        ...
        <div className="xk3Title_1">
          <p className="p1">猜中开奖号码即可中奖<span>240</span>元</p>
        ...
        <div className="NumChoice">
          <div className="column column3">
            <div><p className="p3"><span>1</span><span>1</span><span>1</span></p></div>
            <div><p className="p3"><span>2</span><span>2</span><span>2</span></p></div>
            <div className="redBg"><p className="p3"><span>3</span><span>3</span><span>3</span></p></div>
          </div>
          ...
          <div className="column column3">
            <div><p className="p3"><span>4</span><span>4</span><span>4</span></p></div>
            <div><p className="p3"><span>5</span><span>5</span><span>5</span></p></div>
            <div><p className="p3"><span>6</span><span>6</span><span>6</span></p></div>
          </div>
          <div className="column_missing column_missing3">
            <div>1</div>
            <div>2</div>
