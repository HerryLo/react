...
export class Qian3ZhiXuan extends Component {
  constructor(...args) {
    super(...args);
    this.state = {
      visible: false,
        ...
        <div className="x11x5Betting">
          ...
          <div className="BallChoice redBallChoice">
            <div className="column">
              ...
              {this.Template(1, 6, "hun", "red")}
            </div>
            <div className="column_missing" style={{ display: omitState ? "flex" : "none" }}>
              <div className="emptyDiv2" />
              {this.TemplateOmit(1, 6, m5)}
            </div>
            <div className="column">
              <div className="emptyDiv2" />
              {this.Template(7, 11, "hun", "red")}
              <div className="emptyDiv" />
            </div>
            <div className="column_missing" style={{ display: omitState ? "flex" : "none" }}>
              <div className="emptyDiv2" />
              {this.TemplateOmit(7, 11, m5)}
              <div />
            </div>
          </div>
        </div>
