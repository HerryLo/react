...
import {personal_center_info, loginout, UserIndexAPI} from '../../Stubs/API'
...
class MyCenter extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      username: sessionStorage.getItem('userData') && JSON.parse(sessionStorage.getItem('userData')).uid
    }
