...
import sjbTitle from "../../Img/lotteryBetting/sjbTitle.png"
import banner1 from "../../Img/lotteryBetting/banner1.png"
import banner2 from "../../Img/lotteryBetting/banner2.png"
    ...
    return (
      <div>
        <div id="home" className="listDivView"
          ...
          {/*聚焦世界杯*/}
          <div className="sjbTitleImg"><img src={sjbTitle}/></div>
            ...
            <div>
              <a onClick={() => {
                hashHistory.push({
                  ...
                  query: {
                    title: '聚焦世界杯',
                    url: 'https://5.9188.com/activity/sjbArticle/article_1.html'
                  }
                })
              }}>
                <img src={banner1} className="img1"/>
                <p>俄罗斯世界杯预测：巴西德国有望再造冷门，一队成今夏最大黑马！</p>
              </a>
              <a onClick={() => {
                hashHistory.push({
                  pathname: 'linkPage',
                  query: {
                    title: '聚焦世界杯',
                    url: 'https://5.9188.com/activity/sjbArticle/article_2.html'
                  }
                })
              }}>
                <img src={banner2}/>
                <p>世界杯冠军热门：巴西誓复仇，德国欲破魔咒，梅西C罗谁先捧杯？</p>
              </a>
            </div>
          </div>
          {/*聚焦世界杯 end*/}
