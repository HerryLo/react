...
/**
 * http://mobilev2.9188.com/data/app/gyj/18001/gj.json
 * http://mobilev2.9188.com/data/app/gyj/18001/gyj.json
 * 冠亚军数据接口
 */
export const ShiJieBeiGJ = () => {
  return apiUtils.jsonGet(`/data/app/gyj/18001/gj.json`);
}

export const ShiJieBeiGYJ = () => {
  return apiUtils.jsonGet(`/data/app/gyj/18001/gyj.json`);
}