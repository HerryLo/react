 ...
 * @params {Object}
 * */
export const relatedRegister = params => {
  return apiUtils.commonPost('/wechat/webRegisterUser.go', params)
}

/* 联合登陆登陆关联
 * @params {Object}
 * */
export const relatedLogin = params => {
  return apiUtils.commonPost('/wechat/webBindUserId.go', params)
}

/* 联合登陆已关联登陆
 * @params {Object}
 * */
export const relatedAgreeLogin = params => {
  return apiUtils.commonPost('/wechat/wechatAgreeLogin.go', params)
}
